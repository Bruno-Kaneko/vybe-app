  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column" }}>
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 80 }}>
        {tab === "home" && <FeedTab venues={venues} loading={loadingVenues} profile={profile} onGoToProfile={() => setTab("perfil")} />}
...
/* ── FEED ── */
function FeedTab({ venues, loading, profile, onGoToProfile }: { venues: Venue[]; loading: boolean; profile: Profile | null; onGoToProfile: () => void }) {
  return (
