...
export default function LoginPage() {
  ...
  async function handleForgotPassword() {
    ...
    if (error) setForgotError("Não encontramos esse e-mail. Verifique e tente novamente.");
  ...
  return (
    <>
      <main style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 28px 40px" }}>
        <div style={{ width: "100%", maxWidth: 430 }}>
          ...
          <button
            ...
            style={{ display: "block", width: "100%", background: "none", border: "none", textAlign: "center", color: "var(--mt)", fontSize: 12, marginTop: 16, cursor: "pointer", fontFamily: "inherit" }}
          >
            Esqueci minha senha
          </button>
        </div>
      ...
      {showForgot && (
        <>
          <div onClick={() => setShowForgot(false)} style={{ position: "fixed", inset: 0, background: "#00000088", zIndex: 200 }} />
          <div style={{ position: "fixed", left: 20, right: 20, top: "50%", transform: "translateY(-50%)", background: "var(--card)", border: "0.5px solid var(--bd)", borderRadius: 24, padding: 28, zIndex: 210 }}>
            <div style={{ fontSize: 18, fontWeight: 900, color: "var(--txt)", marginBottom: 8 }}>Redefinir senha</div>
            <div style={{ fontSize: 13, color: "var(--mt)", marginBottom: 20, lineHeight: 1.6 }}>
            ...
            {forgotSent ? (
              ...
              <>
                ...
                />
                {forgotError && <div style={{ color: "#EF4444", fontSize: 12, marginBottom: 10 }}>{forgotError}</div>}
                <button
            ...
            <button
              ...
              style={{ width: "100%", background: "none", border: "none", color: "var(--mt)", marginTop: 14, padding: "6px 0", cursor: "pointer", fontSize: 13, fontFamily: "inherit" }}
            >
              Fechar
            </button>
          </div>
